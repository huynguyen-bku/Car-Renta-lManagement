    ...
    public partial class FormAddCar : Form
    {
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            ...
            if (check == 1)
            {
                ...
                if (txt_status.Text != "") newTruck.status = Int32.Parse(txt_status.Text.ToString());
                else newTruck.status = 0;
                newCar = null;
            }
            else 
            {
                ...
                if (txt_status.Text != "") newCar.status = Int32.Parse(txt_status.Text.ToString());
                else newCar.status = 0;
                newTruck = null;
            }
            this.Close();
        }
